...
function renderNews() {
    ...
    if (iTotalNews) {
        ...
        if (entry1) {
            ...
            setTimeout(function () {
                $(".post-header").append(oNewsArticlePager.socialMediatemplate.replace(/@title/g, sTitle).replace(/@newsimagesrc/g, src).replace("@fbunewslink", encodeURI('https://maqhemantk.github.io/news-article.html?title=' + sRawTitle)).replace("@newslink", "https://maqhemantk.github.io/news-article.html?title=" + sRawTitle).replace("@twitternewslink", encodeURI("https://maqhemantk.github.io/news-article.html?title=" + sRawTitle)).replace("@linkedinnewslink", encodeURI("https://maqhemantk.github.io/news-article.html?title=" + sRawTitle))
