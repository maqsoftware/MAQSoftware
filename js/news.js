...
var oNewsPager = {
    template:
      '<article class="post"> <div class="post-content with-background"> <h2 class="post-title center"><a href="@href">@title</a> </h2> <div class="post-info center"> <span class="post-date">@date</span> </div> <div class="post-media"> <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-color="#ffffff" data-hover-bkg-opacity="0.9"> <a class="overlay-link" href="@href"> <img src="@newsimagesrc" alt="News" title="@tooltip"/> <span class="overlay-info"> <span> <span> Read Full Article </span> </span> </span> </a> </div> </div> <p>@content</p> <a href="@href" class="read-more">Read More →</a> <div class="post-author"> <div class="row"> <div class="column width-12"> <div class="author-bio"> <div class="author-avatar clear-float"> <img src="/images/logos/MAQ-logo-square.png" alt="MAQ Software Logo"> </div> <div class="author-content"> <div class="row"> <div class="column width-12"> <div class="name">by Team MAQ Software </div> <p class="author-title">Engineers, experts & tech enthusiasts </p> </div> </div> </div> </div> </div> </div> </div> </div> </article><br><br><br><br><br>',
    pageIndex: 0,
    pagesize: 3,
},
  id,
